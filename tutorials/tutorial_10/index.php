...
<head>
    ...
    <title>Tutorial_10 | Index Page</title>
...
<body>
    ...
    <h1>Tutorial 08</h1>
    <div class="clearfix">
    <button class="logout-btn login-link"><a href="logout.php">Logout</a></button>
    </div>
    <div class="clearfix">
        <div class="left">
            <h2>Add Student Info</h2>
            <p class="error"><?php if($errorMessage == 1){ echo $_SESSION['error']['message']; } ?></p>
            <p class="success"><?php if($errorMessage == 1){ echo $_SESSION['success']['message']; } ?></p>
